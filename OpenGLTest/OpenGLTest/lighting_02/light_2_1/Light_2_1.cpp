...
//		objectShader.setVec3("lightColor", glm::vec3(0.2f, 0.5f, 1.0f));
//		objectShader.setVec3("objectColor", glm::vec3(1.0, 1.0f, 0.5f));
//
//		glBindVertexArray(VAO);
...
int main()
{
	...
	// ------------------------------------
	Shader lightingShader("lighting_02/light_2_1/vert.vs", "lighting_02/light_2_1/frag.fs");
	Shader lampShader("lighting_02/light_2_1/vert.vs", "lighting_02/light_2_1/light.fs");
