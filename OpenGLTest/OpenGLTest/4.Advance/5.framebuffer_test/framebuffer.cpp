...
{
	Tool::MyGlInitGLFW(3);
	GLFWwindow *window = Tool::MyGlCreateWindow("framebuffertest", SCR_WIDTH, SCR_HEIGHT);
	Tool::MyGlInitLoader();
	...
	unsigned int floorTexture = Tool::LoadTexture("resources/texture/metal.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(0);
		//前面将所有像素渲染到texturecolorbuffer中，类似于RenderTexture
